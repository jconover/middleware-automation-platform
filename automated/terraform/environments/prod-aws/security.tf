...
# -----------------------------------------------------------------------------
# Liberty EC2 Egress Rules (separate to avoid dependency cycles)
# -----------------------------------------------------------------------------
resource "aws_security_group_rule" "liberty_egress_to_db" {
  type                     = "egress"
  from_port                = 5432
  to_port                  = 5432
  protocol                 = "tcp"
...
resource "aws_security_group_rule" "liberty_egress_to_cache" {
  type                     = "egress"
  from_port                = 6379
  to_port                  = 6379
  protocol                 = "tcp"
